...
<div class="bs-example">
    ...
    <form action="/PCInvertory/login" id="UserLoginForm" method="post" accept-charset="utf-8">
    ...
    <input name="data[Employee][username]" maxlength="20" type="text" id="UserUsername" required="required" class="form-control"/>
    </div>
