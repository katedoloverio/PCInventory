...
<li>
                <li ><a href="<?php echo $this->webroot;?>monitor/index">Keyboard<span style="font-size:16px;"></span></a></li>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">Video Card Manangement <span class="sr-only">(current)</span></a></li>
        <li>  <a href="#add" data-toggle="modal"> <i class="glyphicon glyphicon-plus"> </i> Add Video Card </a></li>
...
<div  class="panel panel-default" >
        ...
        <div class="panel-heading" >Video Card  Table </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
               <i class="glyphicon glyphicon-plus"></i> Add Video Card
            </div>
            ...
            <div  class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="available">Status</label>
                     <select name="vcstatus" id="vcstatus" class="form-control">
                ...
                <div class="form-group">
                    <label for="available">Type</label>
                     <select name="vctype" id="mstype" class="form-control">
                  ...
                  <div class="form-group">
                    <label for="available">Availability</label>
                      ...
                      <select name="vcavailability" id="vcavailability" class="form-control">
...
<!-- EDIT Video card DETAILS -->
<?php foreach($videocards  as $row){ ?>

<div class="modal fade" id="edit<?php echo $row['Videocard']['id'];?>" tabindex="-1" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <form action = "editvc" method ="post">

                <div class="modal-body">
                    <input type="text" name="id" value="<?php echo  $row['Videocard']['id'];?>"/>
                    <div class="form-group">
                        <label for="vcpropertyno">Property No.</label>
                        <input type="text" name="vcpropertyno" id="vcpropertyno" value="<?php echo $row['Videocard']['id']; ?>" class="form-control"/>
                    </div>
                     <div class="form-group">
                        <label for="vcdescription">Description</label>
                        <input type="text" name="vcdescription" id="vcdescription" value="<?php echo $row['Videocard']['vcdescription']; ?>" class="form-control"/>
                    </div>
                     
                    
                    <div class="form-group">
                        <label for="vcstatus">Status</label>
                        <select name="vcstatus" id="vcstatus" class="form-control">
                        <?php $msstatus = $row['Videocard']['msstatus'];
                        if ($msstatus == 1){?>
...
<?php
                    ...
                    <div class="form-group">
                        <label for="vctype">Type</label>
                        <select name="vctype" id="vctype" class="form-control">
                        <?php $vcstype = $row['Videocard']['vctype'];
                        if ($vctype == 1){?>
...
<?php
                    ...
                    <div class="form-group">
                        <label for="vcavailability">Availability</label>
                        <select name="vcavailability" id="vcavailability" class="form-control">
                        <?php $vcavailability = $row['Videocard']['vcavailability'];
                        if ($vcavailability == 1){?>
...
<!-- This modal for Delete Video Card -->
<?php foreach($videocards  as $row){ ?>

<div class="modal fade" id="delete<?php echo $row['Videocard']['id'];?>" tabindex="-1" role="dialog">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="deletevc" method="post">
                <div class="modal-body">
                    <input type="hidden" name="id" value="<?php echo  $row['Videocard']['id'];?>"/>
...
<!-- This modal for View Video card -->
<?php foreach($videocards  as $row){ 
    ?>

<div class="modal fade" id="view<?php echo $row['Videocard']['id'];?>" tabindex="-1" role="dialog">
