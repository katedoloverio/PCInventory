...
<?php echo $inventory['Keyboard']['kbpropertyno'] ?></a></td>
 ...
 <td>
        ...
        <a href="#delete<?php echo $inventory['Inventory']['id'];?>" data-toggle="modal" class="btn btn-danger btn-xs"  title="Delete"><i class="glyphicon glyphicon-trash"> </i>Delete</a></td>
    </tr>
    <?php endforeach; ?>
</table>
...
<div class="modal fade" id="viewsu<?php echo $inventory['Inventory']['systemunit_id']?>" tabindex="-1" role="dialog">
...
<div class="modal fade" id="viewmo<?php echo $inventory['Inventory']['monitor_id']?>" tabindex="-1" role="dialog">
...
<div class="modal fade" id="viewvc<?php echo $inventory['Inventory']['videocard_id']?>" tabindex="-1" role="dialog">
...
<div class="modal fade" id="viewkb<?php echo $inventory['Inventory']['keyboard_id']?>" tabindex="-1" role="dialog">
