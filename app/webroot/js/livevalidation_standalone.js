...
LiveValidation.prototype = {
    ...
    initialize: function(element, optionsObj){
      ...
      this.validMessage = options.validMessage || 'Valid!';
...
var Validate = {
    ...
    Presence: function(value, paramsObj){
    	...
    	var message = paramsObj.failureMessage || ""+"*Field Required!";
    ...
    Numericality: function(value, paramsObj){
    	...
    	var tooLowMessage = paramsObj.tooLowMessage || "</br>"+"Must not be less than " + minimum + "!";
    	var tooHighMessage = paramsObj.tooHighMessage || "</br>"+"Must not be more than " + maximum + "!";
   ...
   *                           (DEFAULT: false)
    ...
    Format: function(value, paramsObj){
      ...
      var paramsObj = paramsObj || {};
      var message = paramsObj.failureMessage || "Input must be atleast 3 characters long and must contain letters only";
      var pattern = paramsObj.pattern || /./;
      var negate = paramsObj.negate || false;
      if(value === '' || value === null || value === undefined) Validate.fail(message);// empty field
